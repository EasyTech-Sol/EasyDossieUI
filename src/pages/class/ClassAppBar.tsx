...
import { AppBar, Box, Breadcrumbs, Button, Divider, IconButton, Tab, Tabs, Toolbar, Typography, Tooltip } from '@mui/material';
            ...
            <AppBar position="relative" color="transparent" elevation={0}>
                ...
                >
                    ...
                    <Box sx={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
                        ...
                        >
                            <Tab value="dossiers" label="Dossiês" sx={{ fontSize: '1rem', fontWeight: 500, mx: 20 }} />
                            <Tab value="students" label="Alunos" sx={{ fontSize: '1rem', fontWeight: 500, mx: 20 }} />
                        </Tabs>
                    </Box>
